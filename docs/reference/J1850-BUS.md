...
| 6 | Grey | +12V Ignition (switched) | Power | **Blue** | **cluster power source** → protected chain (fuse / reverse-polarity / load-dump TVS) → Mini560 → board 5V header. See [`../../firmware/docs/reference/bike-power-injection.md`](../../firmware/docs/reference/bike-power-injection.md). (Powering off switched 12V also makes a separate ignition-detect GPIO redundant.) |
