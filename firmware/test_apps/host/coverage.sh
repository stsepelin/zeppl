...
SCOPED=(
    ...
    '*/main/connectivity/phone/phone_data.c'
    '*/main/connectivity/phone/phone_protocol.c'
    '*/main/connectivity/phone/telemetry_codec.c'
    '*/main/connectivity/phone/raw_sniff_codec.c'
    '*/main/contract/command.c'
    '*/main/display/settings/settings.c'
    '*/main/engine/vehicle/vehicle_data.c'
    '*/main/engine/vehicle/gear_calc.c'
    '*/main/engine/vehicle/trip_meter.c'
    '*/main/engine/vehicle/odo_meter.c'
    '*/main/connectivity/ble/ble_visibility.c'
    '*/main/display/gps/nmea.c'
    '*/main/display/gps/gps_source.c'
    '*/main/display/map/map_cells.c'
    '*/main/engine/j1850/j1850_vpw.c'
    '*/main/engine/j1850/j1850_tx_logic.c'
    '*/main/engine/j1850/j1850_parse.c'
