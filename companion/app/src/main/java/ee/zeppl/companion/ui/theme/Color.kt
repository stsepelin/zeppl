...
// the phone and the dash read as one product: Zeppl orange on near-black,
...
private val ZepplOrange       = Color(0xFFFF6600)  // primary accent (cursor, fuel fill)
private val ZepplOrangeSoft   = Color(0xFFFFB68E)  // lifted tone for on-dark legibility

val ZepplDarkColors = darkColorScheme(
    primary              = ZepplOrange,
